            ...
            <div class="row">
                ...
                <div class="col-md-6">
                  ...
                  <div class="col-half">
                    ...
                    <p style="color: #dc3545; margin-top: 5px; display: none;" data-testid="file-error-message">Format non autorisé. Merci de choisir un fichier au format jpg, jpeg ou png.</p>
                  </div>
                </div>
            </div>
            <div class="row">
